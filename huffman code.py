...
# Writing the codes and the encoded output to external text files #
...
while(flag == True):
    ...
    if(num == 0):
        ...
        """ Second Test """
        f=open(r"C:\Users\LENOVO\Desktop\TEST2.txt","r") 
        data1 = f.read()
        print("\nTest 2 data input : ",data1)
        encoding1, tree1 = Huffman_coding(data1)
        print("\nEncoded output :\n", encoding1)
        reverse = input("\nWould you like to decode the file ?\tType (y) for yes and (n) for no\t")
        if(reverse == 'y'):
            print("\nDecoded Output :\n", Huffman_Decoding(encoding1,tree1))
        ...
        encoding2, tree2 = Huffman_coding(data2)
        print("\nEncoded output :\n", encoding2)
        reverse = input("\nWould you like to decode the file ?\tType (y) for yes and (n) for no\t")
        if(reverse == 'y'):
            print("\nDecoded Output :\n", Huffman_Decoding(encoding2,tree2))

    elif(num == 4):

        """ PDF Test """
    
        pdf2text('C://Users/LENOVO/Desktop/EMP214.pdf')

        f = open(r"C:\Users\LENOVO\Out.txt", "r")
        data3 = f.read()
        print("\nPDF test data input :\n",data3)
        encoding3, tree3 = Huffman_coding(data3)
        print("\nEncoded output :\n", encoding3)
        reverse = input("\nWould you like to decode the file ?\tType (y) for yes and (n) for no\t")
        if(reverse == 'y'):
            print("\nDecoded Output :\n", Huffman_Decoding(encoding3,tree3))
        ...
        encoding4, tree4 = Huffman_coding(data4)
        print("\nEncoded output :\n", encoding4)
        reverse = input("\nWould you like to decode the file ?\tType (y) for yes and (n) for no\t")
        if(reverse == 'y'):
            print("\nDecoded Output :\n", Huffman_Decoding(encoding4,tree4))
        ...
        data5 = f.read()
        print("\nPDF test data input :\n",data5)
        encoding5, tree5 = Huffman_coding(data5)
        print("\nEncoded output :\n", encoding5)
        reverse = input("\nWould you like to decode the file ?\tType (y) for yes and (n) for no\t")
        if(reverse == 'y'):
            print("\nDecoded Output :\n", Huffman_Decoding(encoding5,tree5))
